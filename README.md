...
The program requires [Python 2.7 or 3.x](www.python.org/download/) and [Qt4 for Python](www.riverbankcomputing.com/software/pyqt/download).
...
Das Programm benötigt [Python  2.7 or 3.x](www.python.org/download/) und [Qt4 für Python](www.riverbankcomputing.com/software/pyqt/download) dazu.
